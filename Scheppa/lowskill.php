...
<body>
  ...
  <div class="main">
    <div class="sidenav">
      ...
      <a href="lowskill.php" style="color: rgb(218, 143, 6);">Low Skilled Workers</a>
    ...
    <section style="background-color:whitesmoke; background-size: cover;">
      ...
      <form name="search_form" method="post" action="lowskill.php">
        <?php include("location.php") ?>


        <!--cards -->
        <?php
        $query = "select * from schepparegistration1 where prof='Low Skill Worker'";
        ...
        <?php
          ...
          echo ("<script>location.href='lowskill.php'</script>");
        }
        ?>
  </div>
