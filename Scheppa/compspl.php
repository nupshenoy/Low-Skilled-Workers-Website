...
<head>
    <title>Computer Specialists</title>
</head>
...
<body>
    ...
    <div class="main">
        <div class="sidenav">
            ...
            <a href="designers.php" style="color: rgb(218, 143, 6);">Computer Specialists</a>
        ...
        <section style="background-color:whitesmoke; background-size: cover;">
            <form name="search_form" method="post" action="compspl.php">
                <?php include("location.php") ?>
                <!--cards -->

                <?php
                $query = "select * from schepparegistration1 where prof='Computer Specialist'";
                ...
                <?php
                    ...
                    echo ("<script>location.href='compspl.php'</script>");
                }
                ?>
