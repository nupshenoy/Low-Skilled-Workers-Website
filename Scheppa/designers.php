...
<body>
  ...
  <div class="main">
    <div class="sidenav">
      ...
      <a href="designers.php" style="color: rgb(218, 143, 6);">Designers</a>
    </div>
    <section style="background-color:whitesmoke; background-size: cover;">

      <section style="background-image: url(bgpage1.jpg); background-size: cover;">
        <form name="search_form" method="post" action="designers.php">
          <?php include("location.php") ?>

          <!--cards -->

          <?php
          $query = "select * from schepparegistration1 where prof='Designer'";
          ...
          ?>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="des">
                    <p><?php echo $descp; ?> </p>
                    <button><a href="profileview.php?id=<?php echo $id ?>">
                        View More</a></button>
                  </div>
                </div>
              </div>
          ...
          <?php
            ...
            echo ("<script>location.href='designers.php'</script>");
          }
          ?>
  </div>
