...
<body>
    <nav class="navbar navbar-expand-sm bg-custom-1" style="height:100px;">
        ...
        <div class="container-fluid">
            <!-- Links -->
            <a class="navbar-brand" href="home-explore.php" style="color: white; text-decoration: none; font-size: 40px; font-weight: 600; text-shadow: 2px 2px 4px #000000; padding: 8px 10px;">Scheppa</a>
            <div class="navbar-collapse collapse" id="navbarCustom">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="header-info" href="registration%20(1).php"><button class="login" id="login" style="margin-top:15px;">Register</button></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="album py-5 bg-dark">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-outline-secondary"><a href="profileview.php?id=36">
                                            View More</a></button>
                ...
                <div class="col" data-aos="fade-up-right">
                    <div class="card shadow-sm">
                        <img class="card-img-top" src="ronyjames7.jpg" alt="Image of Aju Jose">
                        <!--<svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>-->
                ...
                <div class="col" data-aos="fade-up-right">
                    <div class="card shadow-sm">
                        <img class="card-img-top" src="Anamikaraj3.jpg" alt="Image of Aju Jose">
                        <!--<svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>-->
                        <div class="card-body">
                            <h3>Anamika Raj</h3>
